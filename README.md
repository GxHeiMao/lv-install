...
## 方法一：一键安装或更新到最新 ##
 <pre><code>wget -q -N --no-check-certificate https://raw.githubusercontent.com/GxHeiMao/lv-install/v1.2.0/install.sh && chmod 777 install.sh && bash install.sh</code></pre>
